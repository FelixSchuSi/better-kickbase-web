import{B as h,r as v,e as p,t as c,s as g,n as f}from"./chunks/chunk.4392602e.js";import{b,$ as m}from"./chunks/chunk.322bb44e.js";import{i as d}from"./chunks/chunk.ec1c9bc1.js";import{e as w,i as k,t as S}from"./chunks/chunk.3206916e.js";import{n as P,p as I}from"./chunks/chunk.37b42dac.js";/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const u=w(class extends k{constructor(r){var a;if(super(r),r.type!==S.ATTRIBUTE||r.name!=="class"||((a=r.strings)===null||a===void 0?void 0:a.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(r){return" "+Object.keys(r).filter(a=>r[a]).join(" ")+" "}update(r,[a]){var o,i;if(this.et===void 0){this.et=new Set,r.strings!==void 0&&(this.st=new Set(r.strings.join(" ").split(/\s/).filter(e=>e!=="")));for(const e in a)a[e]&&!(!((o=this.st)===null||o===void 0)&&o.has(e))&&this.et.add(e);return this.render(a)}const t=r.element.classList;this.et.forEach(e=>{e in a||(t.remove(e),this.et.delete(e))});for(const e in a){const n=!!a[e];n===this.et.has(e)||((i=this.st)===null||i===void 0?void 0:i.has(e))||(n?(t.add(e),this.et.add(e)):(t.remove(e),this.et.delete(e)))}return b}});class y extends h{}class D extends y{async getData(a,o="2335868"){await this.ensureLogin();const i=`https://api.better-kickbase.workers.dev/leagues/${o}/players/${a}/`;return await(await fetch(i,this.default_opts)).json()}}const T=new D;function $(r){return{match:r.d,points:r.p,goals:r.g,assists:r.a,home:r.h,playtimeSeconds:r.sp,startingEleven:r.ms,homeTeamId:r.t1i,awayTeamId:r.t2i,homeTeamGoals:r.t1s,awayTeamGoals:r.t2s}}function N(r){return{points:r.p,appearances:r.mp,startingEleven:r.ms,matches:r.m.map($),year:r.t}}class x extends y{async getData(a){await this.ensureLogin();const o=`https://api.better-kickbase.workers.dev/players/${a}/points`;return{seasons:(await(await fetch(o,this.default_opts)).json()).s.map(N)}}}const F=new x;function U(r){return{...r}}function _(r){return{day:new Date(r.d),homeTeamId:r.t1i,homeTeamName:r.t1n,homeTeamNameShort:r.t1y,awayTeamId:r.t2i,awayTeamName:r.t2n,awayTeamNameShort:r.t2y,match:r.md,points:0,playtimeSeconds:0,homeTeamGoals:-1,awayTeamGoals:-1}}class j extends y{async getData(a,o="2335868"){await this.ensureLogin();const i=`https://api.better-kickbase.workers.dev/leagues/${o}/players/${a}/stats`,e=await(await fetch(i,this.default_opts)).json();return{averagePoints:e.averagePoints,f:e.f,firstName:e.firstName,id:e.id,lastName:e.lastName,marketValue:e.marketValue,mvHigh:e.mvHigh,mvHighDate:new Date(e.mvHighDate),mvLow:e.mvLow,mvLowDate:new Date(e.mvLowDate),mvTrend:e.mvTrend,upcomingMatches:e.nm.map(_),number:e.number,points:e.points,position:e.position,profileUrl:e.profileUrl,seasons:e.seasons.map(U),status:e.status,teamCoverUrl:e.teamCoverUrl,teamId:e.teamId,teamUrl:e.teamUrl,userFlags:e.userFlags}}}const L=new j;class A{async getData(a){return{playerInfo:await T.getData(a),playerPoints:await F.getData(a),playerStats:await L.getData(a)}}}const H=new A,O=v`
  :root,
  * {
...
`;var B=Object.defineProperty,E=Object.getOwnPropertyDescriptor,l=(r,a,o,i)=>{for(var t=i>1?void 0:i?E(a,o):a,e=r.length-1,n;e>=0;e--)(n=r[e])&&(t=(i?n(a,o,t):n(t))||t);return i&&t&&B(a,o,t),t};const R="bkb-player";let s=class extends g{async willUpdate(r){const a=!this.playerPoints;if(a){const{playerInfo:o,playerPoints:i,playerStats:t}=JSON.parse(this.serverJsonData);this.playerInfo=o,this.playerPoints=i,this.playerStats=t}if(a){const{playerInfo:o,playerPoints:i,playerStats:t}=await H.getData(this.playerId);this.playerInfo=o,this.playerPoints=i,this.playerStats=t}}get upperHalfStyles(){return{"background-color":`var(--team-primary-color-${this.teamId}, gray)`}}get colorFadeStyles(){return{background:`linear-gradient(to bottom, transparent, var(--team-primary-color-${this.teamId}, gray));`}}render(){return m`
      ...
      ></bkb-player-points>
    `}priceTrendTemplate(r){switch(r){case 1:return m`&#129045;`;case 2:return m` &#129047;`;default:case 0:return m`-`}}};s.styles=[O,v`
      .upper-half {
        width: 100%;
        display: grid;
    ...
    `];l([p({type:String,attribute:"player-name"})],s.prototype,"playerName",2);l([p({type:String,attribute:"player-id"})],s.prototype,"playerId",2);l([p({type:String,attribute:"server-json-data"})],s.prototype,"serverJsonData",2);l([p({type:String,attribute:"team-id"})],s.prototype,"teamId",2);l([c()],s.prototype,"playerInfo",2);l([c()],s.prototype,"playerPoints",2);l([c()],s.prototype,"playerStats",2);s=l([f(R)],s);export{s as PlayerPage,R as tagName};
