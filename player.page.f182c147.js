import{r as u,e as p,t as c,s as v,n as g}from"./chunks/point-formatter.e755dd0c.js";import{b as h,$ as n}from"./chunks/lit-html.154a0938.js";import{i as y}from"./chunks/player-points.1a566d81.js";import{e as f,i as b,t as w}from"./chunks/directive.7cba340f.js";import{n as k,p as S}from"./chunks/price-formatter.dffdf829.js";/**
 * @license
...
`;var O=Object.defineProperty,E=Object.getOwnPropertyDescriptor,l=(r,e,i,t)=>{for(var o=t>1?void 0:t?E(e,i):e,a=r.length-1,m;a>=0;a--)(m=r[a])&&(o=(t?m(e,i,o):m(o))||o);return t&&o&&O(e,i,o),o};let s=class extends v{async willUpdate(r){const e=!this.playerPoints;if(e){const{playerInfo:i,playerPoints:t,playerStats:o}=JSON.parse(this.serverJsonData);this.playerInfo=i,this.playerPoints=t,this.playerStats=o}if(e){const{playerInfo:i,playerPoints:t,playerStats:o}=await A.getData(this.playerId);this.playerInfo=i,this.playerPoints=t,this.playerStats=o}}get upperHalfStyles(){return{"background-color":`var(--team-primary-color-${this.teamId}, gray)`}}get colorFadeStyles(){return{background:`linear-gradient(to bottom, transparent, var(--team-primary-color-${this.teamId}, gray));`}}render(){return n`
      ...
      ></bkb-player-points>
    `}priceTrendTemplate(r){switch(r){case 1:return n`&#129045;`;case 2:return n` &#129047;`;default:case 0:return n`-`}}};s.styles=[H,u`
      .upper-half {
        width: 100%;
        display: grid;
