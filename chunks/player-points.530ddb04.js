import{r as h,e as A,s as b,$ as l,y as m,n as v,t as u,i as Z,a as y}from"../client-shim.63e9c33e.js";function f(e){switch(e){case 1:return"TW";case 2:return"ABW";case 3:return"MIT";case 4:return"ST";case 9999999999:default:return""}}var w=Object.defineProperty,R=Object.getOwnPropertyDescriptor,g=(e,t,a,i)=>{for(var s=i>1?void 0:i?R(t,a):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(s=(i?r(t,a,s):r(s))||s);return i&&s&&w(t,a,s),s};const k="bkb-player-badges";let c=class extends b{render(){return l`
      <div class="badges-container">
        ${this.singleBadge(String(this.number))}
        ${this.singleBadge(f(this.position))}
        ${this.singleBadge(this.status)}
      </div>
    `}singleBadge(e){return e===void 0?"":l`
      ${m`
  ...
  `;g([A({type:Number})],c.prototype,"number",2);g([A({type:String})],c.prototype,"position",2);g([A({type:String})],c.prototype,"status",2);c=g([v(k)],c);var x="/better-kickbase-web/assets/2.b9770161.png",M="/better-kickbase-web/assets/3.c4ecc237.png",I="/better-kickbase-web/assets/4.18b4e12c.png",U="data:image/png;base64,",Y="/better-kickbase-web/assets/7.e4732b84.png",S="/better-kickbase-web/assets/9.0dfad2eb.png",E="/better-kickbase-web/assets/11.0b614101.png",B="/better-kickbase-web/assets/13.9d841356.png",O="/better-kickbase-web/assets/14.63efdbd8.png",T="data:image/png;base64,",H="/better-kickbase-web/assets/18.3780ff0a.png",P="/better-kickbase-web/assets/19.0896da6a.png",G="/better-kickbase-web/assets/20.ea3c24b0.png",N="data:image/png;base64,",Q="data:image/png;base64,",W="/better-kickbase-web/assets/28.a4cea9d1.png",j="data:image/png;base64,",F="/better-kickbase-web/assets/43.a88206a1.png";const p={team_2:x,team_3:M,team_4:I,team_5:U,team_7:Y,team_9:S,team_11:E,team_13:B,team_14:O,team_15:T,team_18:H,team_19:P,team_20:G,team_22:N,team_24:Q,team_28:W,team_40:j,team_43:F};var L=Object.defineProperty,J=Object.getOwnPropertyDescriptor,d=(e,t,a,i)=>{for(var s=i>1?void 0:i?J(t,a):t,n=e.length-1,r;n>=0;n--)(r=e[n])&&(s=(i?r(t,a,s):r(s))||s);return i&&s&&L(t,a,s),s};const z="bkb-player-points";let o=class extends b{constructor(){super(...arguments);this.maxPoints=0,this.numberOfSeasonsToRender=1}willUpdate(e){e.has("points")&&!!this.points?.seasons&&(this.maxPoints=Math.max(...this.points.seasons.flatMap(t=>t.matches).map(t=>t.points)))}render(){let e=[];return this.points?.seasons?.length>0&&(e=this.points.seasons.slice(-this.numberOfSeasonsToRender)),l`
    ...
    `}firstUpdated(e){this.firstUpcomingMatch.scrollIntoView(!1)}updated(e){e.has("numberOfSeasonsToRender")&&this.firstSeasonSummary.scrollIntoView({block:"end",inline:"start"})}seasonTemplate(e){return l`
      <div class="season">
    ...
    `}matchTemplate(e){const t=e.points>=100?"#25c28b":"#ea5f42",a=`${Math.round(e.points/this.maxPoints*100)}%`;return l`
      <div class="match">
        <div class="match-day">
        ...
        <div
          class="match-bar"
          style=${y({background:`linear-gradient(to top, ${t}, ${t}, ${a}, #f5f7f6, ${a}, #f5f7f6);`})}
        >
          ${Array.from({length:e.assists}).map(()=>l`<div>${this.assistSvg}</div>`)}
          ${Array.from({length:e.goals}).map(()=>l`<div>${this.goalSvg}</div>`)}
        </div>
  ...
  `;d([A({type:Object})],o.prototype,"points",2);d([A({type:Array})],o.prototype,"upcomingMatches",2);d([u()],o.prototype,"numberOfSeasonsToRender",2);d([Z(".root > .match")],o.prototype,"firstUpcomingMatch",2);d([Z(".root > .season > .season-summary")],o.prototype,"firstSeasonSummary",2);o=d([v(z)],o);
