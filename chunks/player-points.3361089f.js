import{r as A,e as c,s as b,$ as l,y as h,n as v,i as u,t as w,a as y}from"../client-shim.48ed8262.js";import{g as R,p as x}from"./base.service.55de1ff6.js";var k=Object.defineProperty,M=Object.getOwnPropertyDescriptor,g=(e,t,a,i)=>{for(var s=i>1?void 0:i?M(t,a):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&k(t,a,s),s};const S="bkb-player-badges";let m=class extends b{constructor(){super(...arguments);this.inverted=!1}render(){return l`
  ...
  `;f([c({type:Number,attribute:"max-points"})],p.prototype,"maxPoints",2);f([c({type:Object})],p.prototype,"match",2);p=f([v(X)],p);var V=Object.defineProperty,q=Object.getOwnPropertyDescriptor,d=(e,t,a,i)=>{for(var s=i>1?void 0:i?q(t,a):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&V(t,a,s),s};const K="bkb-player-points";let r=class extends b{constructor(){super(...arguments);this.maxPoints=0,this.numberOfSeasonsToRender=1}willUpdate(e){e.has("points")&&!!this.points?.seasons&&(this.maxPoints=Math.max(...this.points.seasons.flatMap(t=>t.matches).map(t=>t.points)))}render(){let e=[];return this.points?.seasons?.length>0&&(e=this.points.seasons.slice(-this.numberOfSeasonsToRender)),l`
      <div class="root">
  ...
  `;d([c({type:Object})],r.prototype,"points",2);d([c({type:Array})],r.prototype,"upcomingMatches",2);d([w()],r.prototype,"numberOfSeasonsToRender",2);d([y(".root > bkb-player-points-match")],r.prototype,"firstUpcomingMatch",2);d([y(".root > .season > .season-summary")],r.prototype,"firstSeasonSummary",2);d([y(".season-summary:last-of-type")],r.prototype,"lastSeasonSummary",2);r=d([v(K)],r);export{Z as t};
