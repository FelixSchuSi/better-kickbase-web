import{r as g,e as r,s as b,$ as l,y as d,n as v,i as w,a as f}from"../client-shim.48ed8262.js";import{g as u,p as x}from"./base.service.069015bb.js";var k=Object.defineProperty,R=Object.getOwnPropertyDescriptor,h=(e,t,s,i)=>{for(var a=i>1?void 0:i?R(t,s):t,o=e.length-1,c;o>=0;o--)(c=e[o])&&(a=(i?c(t,s,a):c(a))||a);return i&&a&&k(t,s,a),a};const M="bkb-player-badges";let n=class extends b{constructor(){super(...arguments);this.inverted=!1}render(){return l`
  ...
  `;h([r({type:Number})],n.prototype,"number",2);h([r({type:String})],n.prototype,"position",2);h([r({type:String})],n.prototype,"status",2);h([r({type:Boolean})],n.prototype,"inverted",2);n=h([v(M)],n);var U="/better-kickbase-web/assets/2.b9770161.png",Y="/better-kickbase-web/assets/3.c4ecc237.png",I="/better-kickbase-web/assets/4.18b4e12c.png",P="data:image/png;base64,",E="/better-kickbase-web/assets/7.e4732b84.png",S="/better-kickbase-web/assets/9.0dfad2eb.png",B="/better-kickbase-web/assets/11.0b614101.png",H="/better-kickbase-web/assets/13.9d841356.png",N="/better-kickbase-web/assets/14.63efdbd8.png",G="data:image/png;base64,",O="/better-kickbase-web/assets/18.3780ff0a.png",Q="/better-kickbase-web/assets/19.0896da6a.png",T="/better-kickbase-web/assets/20.ea3c24b0.png",j="data:image/png;base64,",W="data:image/png;base64,",F="/better-kickbase-web/assets/28.a4cea9d1.png",L="data:image/png;base64,",J="/better-kickbase-web/assets/43.a88206a1.png";const Z={team_2:U,team_3:Y,team_4:I,team_5:P,team_7:E,team_9:S,team_11:B,team_13:H,team_14:N,team_15:G,team_18:O,team_19:Q,team_20:T,team_22:j,team_24:W,team_28:F,team_40:L,team_43:J};var z=Object.defineProperty,D=Object.getOwnPropertyDescriptor,y=(e,t,s,i)=>{for(var a=i>1?void 0:i?D(t,s):t,o=e.length-1,c;o>=0;o--)(c=e[o])&&(a=(i?c(t,s,a):c(a))||a);return i&&a&&z(t,s,a),a};const C="bkb-player-points-match";let p=class extends b{constructor(){super(...arguments);this.maxPoints=0}render(){const e=this.match.points>=100?"#25c28b":"#ea5f42",t=`${Math.round(this.match.points/this.maxPoints*100)}%`,s={background:`linear-gradient(to top, ${e}, ${e}, ${t}, #f5f7f6, ${t}, #f5f7f6)`};return l`
      <div class="match">
        ...
        <div class="match-team-logos">
          <img class="home-team-logo" src="${Z[`team_${this.match.homeTeamId}`]}" />
          <img class="away-team-logo" src="${Z[`team_${this.match.awayTeamId}`]}" />
        </div>
    ...
    `}matchResultBadgeSvg(e,t){const s=e===-1?"-":String(e??0),i=t===-1?"-":String(t??0);return l`
  ...
  `;y([r({type:Number,attribute:"max-points"})],p.prototype,"maxPoints",2);y([r({type:Object})],p.prototype,"match",2);p=y([v(C)],p);var X=Object.defineProperty,V=Object.getOwnPropertyDescriptor,A=(e,t,s,i)=>{for(var a=i>1?void 0:i?V(t,s):t,o=e.length-1,c;o>=0;o--)(c=e[o])&&(a=(i?c(t,s,a):c(a))||a);return i&&a&&X(t,s,a),a};const q="bkb-player-points";let m=class extends b{constructor(){super(...arguments);this.maxPoints=0}willUpdate(e){e.has("points")&&!!this.points?.seasons&&(this.maxPoints=Math.max(...this.points.seasons.flatMap(t=>t.matches).map(t=>t.points)))}render(){return l`
      <div class="root">
        ${this.points.seasons.map(e=>this.seasonTemplate(e))}
        ${this.upcomingMatches.map(e=>l`<bkb-player-points-match
              .match=${e}
              .maxPoints=${this.maxPoints}
            ></bkb-player-points-match>`)}
      </div>
    `}firstUpdated(e){this.firstUpcomingMatch?this.firstUpcomingMatch?.scrollIntoView(!1):this.lastSeasonSummary?.scrollIntoView(!1)}seasonTemplate(e){const t=e.appearances>0?Math.round(e.points/e.appearances):0;return l`
      <div class="season">
        ${e.matches.map(s=>l`<bkb-player-points-match .match=${s} .maxPoints=${this.maxPoints}></bkb-player-points-match>`)}
        <div class="season-summary">
          <div class="season-summary-details">
            ...
            <div class="season-summary-details-value">${x.format(e.points)}</div>
  ...
  `;A([r({type:Object})],m.prototype,"points",2);A([r({type:Array})],m.prototype,"upcomingMatches",2);A([f(".root > bkb-player-points-match")],m.prototype,"firstUpcomingMatch",2);A([f(".season:last-of-type > .season-summary")],m.prototype,"lastSeasonSummary",2);m=A([v(q)],m);export{Z as t};
