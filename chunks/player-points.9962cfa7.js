import{r as A,e as c,s as b,$ as l,y as h,n as v,i as Z,t as w,a as u}from"../client-shim.48ed8262.js";function R(e){switch(e){case 1:return"TW";case 2:return"ABW";case 3:return"MIT";case 4:return"ST";case 9999999999:default:return""}}var x=Object.defineProperty,k=Object.getOwnPropertyDescriptor,g=(e,t,a,i)=>{for(var s=i>1?void 0:i?k(t,a):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&x(t,a,s),s};const M="bkb-player-badges";let d=class extends b{constructor(){super(...arguments);this.inverted=!1}render(){return l`
  ...
  `;y([c({type:Number,attribute:"max-points"})],p.prototype,"maxPoints",2);y([c({type:Object})],p.prototype,"match",2);p=y([v(C)],p);var X=Object.defineProperty,V=Object.getOwnPropertyDescriptor,m=(e,t,a,i)=>{for(var s=i>1?void 0:i?V(t,a):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&X(t,a,s),s};const q="bkb-player-points";let r=class extends b{constructor(){super(...arguments);this.maxPoints=0,this.numberOfSeasonsToRender=1}willUpdate(e){e.has("points")&&!!this.points?.seasons&&(this.maxPoints=Math.max(...this.points.seasons.flatMap(t=>t.matches).map(t=>t.points)))}render(){let e=[];return this.points?.seasons?.length>0&&(e=this.points.seasons.slice(-this.numberOfSeasonsToRender)),l`
    ...
    `}firstUpdated(e){this.firstUpcomingMatch?.scrollIntoView(!1)}updated(e){e.has("numberOfSeasonsToRender")&&this.firstSeasonSummary?.scrollIntoView({block:"end",inline:"start"})}seasonTemplate(e){const t=e.appearances>0?Math.round(e.points/e.appearances):0;return l`
      <div class="season">
  ...
  `;m([c({type:Object})],r.prototype,"points",2);m([c({type:Array})],r.prototype,"upcomingMatches",2);m([w()],r.prototype,"numberOfSeasonsToRender",2);m([u(".root > .match")],r.prototype,"firstUpcomingMatch",2);m([u(".root > .season > .season-summary")],r.prototype,"firstSeasonSummary",2);r=m([v(q)],r);
