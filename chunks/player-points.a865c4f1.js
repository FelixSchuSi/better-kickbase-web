import{r as A,e as c,s as b,$ as l,y as h,n as v,i as Z,t as w,a as y}from"../client-shim.48ed8262.js";function R(e){switch(e){case 1:return"TW";case 2:return"ABW";case 3:return"MIT";case 4:return"ST";case 9999999999:default:return""}}var k=Object.defineProperty,x=Object.getOwnPropertyDescriptor,g=(e,t,a,i)=>{for(var s=i>1?void 0:i?x(t,a):t,o=e.length-1,n;o>=0;o--)(n=e[o])&&(s=(i?n(t,a,s):n(s))||s);return i&&s&&k(t,a,s),s};const M="bkb-player-badges";let m=class extends b{constructor(){super(...arguments);this.inverted=!1}render(){return l`
  ...
  `;d([c({type:Object})],r.prototype,"points",2);d([c({type:Array})],r.prototype,"upcomingMatches",2);d([w()],r.prototype,"numberOfSeasonsToRender",2);d([y(".root > bkb-player-points-match")],r.prototype,"firstUpcomingMatch",2);d([y(".root > .season > .season-summary")],r.prototype,"firstSeasonSummary",2);d([y(".season-summary:last-of-type")],r.prototype,"lastSeasonSummary",2);r=d([v(q)],r);
