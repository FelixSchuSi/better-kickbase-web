import{r as u,e as p,t as n,s as g,$ as m,i as s,o as d,n as b}from"./client-shim.48ed8262.js";import{n as v,p as h}from"./chunks/price-formatter.395600fd.js";import"./chunks/player-points.8a671821.js";const f=u`
  :root,
  * {
...
`;var k=Object.defineProperty,$=Object.getOwnPropertyDescriptor,e=(t,i,l,o)=>{for(var a=o>1?void 0:o?$(i,l):i,c=t.length-1,y;c>=0;c--)(y=t[c])&&(a=(o?y(i,l,a):y(a))||a);return o&&a&&k(i,l,a),a};const I="bkb-player";let r=class extends g{async willUpdate(t){if(!this.playerPoints){const{playerInfo:l,playerPoints:o,playerStats:a}=JSON.parse(this.serverJsonData);this.playerInfo=l,this.playerPoints=o,this.playerStats=a}}get upperHalfStyles(){return{"background-color":`var(--team-primary-color-${this.teamId}, gray)`}}get colorFadeStyles(){return{background:`linear-gradient(to bottom, transparent, var(--team-primary-color-${this.teamId}, gray));`}}render(){return m`
      <div class="upper-half" style=${s(this.upperHalfStyles)}>
        <img
          class="player-image"
          src=${this.playerInfo?.profileBig??v}
          ...
          >
            <div class="price-container">
              <h3 class="price-value">
                ${h.format(this.playerInfo.marketValue??0)}&nbsp${this.priceTrendTemplate(this.playerInfo.marketValueTrend)}
              </h3>
            </div>
          </div>
          <h1
      ...
      ></bkb-player-points>
    `}priceTrendTemplate(t){switch(t){case 1:return m`&#129045;`;case 2:return m` &#129047;`;default:case 0:return m`-`}}};r.styles=[f,u`
      .upper-half {
        width: 100%;
        display: grid;
    ...
    `];e([p({type:String,attribute:"player-name"})],r.prototype,"playerName",2);e([p({type:String,attribute:"player-id"})],r.prototype,"playerId",2);e([p({type:String,attribute:"server-json-data"})],r.prototype,"serverJsonData",2);e([p({type:String,attribute:"team-id"})],r.prototype,"teamId",2);e([n()],r.prototype,"playerInfo",2);e([n()],r.prototype,"playerPoints",2);e([n()],r.prototype,"playerStats",2);r=e([b(I)],r);export{r as PlayerPage,I as tagName};
